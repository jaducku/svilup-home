...
import WebTechCard from './WebTechCard';
...
class WebTechMain extends Component {
    constructor(props){
        super(props);
        this.state = {
...
WebTechMain.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default graphql(getTeches)(withStyles(styles)(WebTechMain));